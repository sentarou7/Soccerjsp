...
public class CheckUtil {
    ...
    public void StringTypeCheck(String value, String name) {
        if (value != null && !value.isBlank()) {
            if(value.matches("\\d*")) {
            	this._errs.add(name+"は文字で入力してください。");
            }
        }
    }
    ...
    public void duplicateChecked(String value,String pattern,String name){
        if(value != null && !value.isBlank()){
